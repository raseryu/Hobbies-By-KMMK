...
function initAdminDropdown() {
  ...
  // Redirect back to the React app's admin login page on the same origin/port.
  // This avoids hard-coding Vite's default 5173 port when the app is running on a different port.
  const storeAdminLoginUrl = window.STORE_ADMIN_LOGIN_URL || `${window.location.origin}/admin-login`;
